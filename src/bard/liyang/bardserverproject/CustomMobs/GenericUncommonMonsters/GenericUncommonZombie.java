...
public class GenericUncommonZombie extends EntityZombie{
	...
	public GenericUncommonZombie(Location loc)
	{
		...
		craftZombie.setCustomName(ChatColor.DARK_GREEN + GenericNameGenerator.generateGenericName());
		craftZombie.setCustomNameVisible(true);
		craftZombie.setMetadata("UncommonLoot", meta);
		craftZombie.setRemoveWhenFarAway(true);
		
		ItemStack sword = new GenericUncommonItem(1);
		ItemStack head; 
